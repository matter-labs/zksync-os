...
fn main() -> ExitCode {
    ...
    let local_error_types_path = "errors/types/airbender-specific.json";
    ...
    let arguments = GenerationArguments {
        ...
        // Substitutes type bindings for U256 and other types
        // normally imported from the zksync_basic_types crate. Instead, we use
        // types imported from the `ruint` crate, like everything else in Airbender.
        override_links: vec![(
