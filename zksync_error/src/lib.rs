...
pub mod os {
    ...
    pub mod evm {
        ...
        pub use crate::error::definitions::EVM::InvalidArguments;
        #[macro_export]
        macro_rules ! os_evm_generic_error { ($ ($ arg : tt) *) => { zksync_error :: os :: evm :: EVMError :: GenericError { message : format ! ($ ($ arg) *) } } ; }
        pub use crate::os_evm_generic_error as generic_error;
        pub fn to_generic<T: std::fmt::Display>(err: T) -> EVMError {
            GenericError {
                message: err.to_string(),
            }
        }
        pub fn to_domain<T: std::fmt::Display>(err: T) -> super::OsError {
            super::OsError::EVM(GenericError {
                message: err.to_string(),
            })
        }
    }
    pub mod ee {
        ...
        pub use crate::error::definitions::ExecutionEnvironments::Evm;
        pub use crate::error::definitions::ExecutionEnvironments::GenericError;
        pub use crate::error::definitions::ExecutionEnvironments::Wasm;
        ...
        pub fn to_generic<T: std::fmt::Display>(err: T) -> ExecutionEnvironmentsError {
            GenericError {
                message: err.to_string(),
            }
        }
    ...
    pub mod store {
        ...
        #[macro_export]
        macro_rules ! os_store_generic_error { ($ ($ arg : tt) *) => { zksync_error :: os :: store :: StorageError :: GenericError { message : format ! ($ ($ arg) *) } } ; }
        pub use crate::os_store_generic_error as generic_error;
        pub fn to_generic<T: std::fmt::Display>(err: T) -> StorageError {
            GenericError {
                message: err.to_string(),
            }
        }
