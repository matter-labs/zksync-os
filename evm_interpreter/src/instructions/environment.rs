...
impl<S: EthereumLikeTypes> Interpreter<'_, S> {
    pub fn chainid(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BASE, CHAINID_NATIVE_COST)?;
    ...
    pub fn coinbase(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BASE, COINBASE_NATIVE_COST)?;
    ...
    pub fn timestamp(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BASE, TIMESTAMP_NATIVE_COST)?;
    ...
    pub fn number(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BASE, NUMBER_NATIVE_COST)?;
    ...
    pub fn difficulty(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BASE, DIFFICULTY_NATIVE_COST)?;
    ...
    pub fn gasprice(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BASE, GASPRICE_NATIVE_COST)?;
    ...
    pub fn basefee(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BASE, BASEFEE_NATIVE_COST)?;
    ...
    pub fn origin(&mut self, system: &mut System<S>) -> InstructionResult {
        ...
        {
            self.gas
                .spend_step_gas_and_native(gas_constants::BASE, ORIGIN_NATIVE_COST)?;
    ...
    pub fn blockhash(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BLOCKHASH, BLOCKHASH_NATIVE_COST)?;
    ...
    pub fn blobhash(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BLOBHASH, BLOBHASH_NATIVE_COST)?;
    ...
    pub fn blobbasefee(&mut self, system: &mut System<S>) -> InstructionResult {
        self.gas
            .spend_step_gas_and_native(gas_constants::BASE, BLOBBASEFEE_NATIVE_COST)?;
