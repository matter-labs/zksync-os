...
use alloc::boxed::Box;
use error::{EvmSubsystemErrors, EvmSystemWideError};
use core::any::Any;
use core::fmt::Write;
use errors::{RuntimeError, SystemFunctionError, Error};
...
,
    ...
    ) -> Result<zk_ee::system::ExecutionEnvironmentPreemptionPoint<'a, S>, EvmSystemWideError> {
