...
impl<'a, A: Allocator + Clone> EthereumMPT<'a, A> {
        ...
        D::HashOutput: AsRef<[u8]>,
    {
        ...
        let (_, (_, existing_node)) = self
            .extension_nodes
            .get_persistent_mut_by_index(node.index());
        ...
        let new_extension_key =
            interner.update_extension_value(existing_node, pre_encoded_extension_value, hasher)?;
