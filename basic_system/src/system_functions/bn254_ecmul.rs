...
>(
    ...
    let serialized_result = unsafe {
        let x0 = it.next().unwrap_unchecked().try_into().unwrap_unchecked();
        let y0 = it.next().unwrap_unchecked().try_into().unwrap_unchecked();
        let scalar = it.next().unwrap_unchecked().try_into().unwrap_unchecked();
