...
COMPONENTS = [
    ...
    ("storage slot cache", r"generic_pubdata_aware_plain_storage|full_storage_cache|EthereumStorageCache|storage_read|storage_write|storage_touch|StorageCacheModel"),
