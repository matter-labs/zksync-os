...
impl<'external, S: EthereumLikeTypes> Run<'_, 'external, S> {
        ...
        S::IO: IOSubsystemExt,
    {
        ...
        match run_call_preparation(is_entry_frame, self.system, ee_type, &call_request) {
            Ok(CallPreparationResult::Success {
                ...
                new_vm = create_ee(next_ee_version, self.system).map_err(propagate)?;
        ...
        S::IO: IOSubsystemExt,
    {
        ...
        let mut constructor = create_ee(ee_type as u8, self.system).map_err(propagate)?;
        ...
        launch_params
            ...
            .map_err(|e| match e {
                UpdateQueryError::System(SystemError::OutOfNativeResources) => {
                    BootloaderSubsystemError::Runtime(
