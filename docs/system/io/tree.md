...
- A new write costs `5 * DEPTH` hashes (2 for the "empty read", 1 for the update of the left neighbor and 2 for the update of the new leaf(TODO: clarify that read is needed to get merkle path to be used during write)).
